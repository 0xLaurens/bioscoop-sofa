...
public class Tests
{
    ...
    // 2. The order must be placed on a regular day. 
    [Test]
    public void CalculatePrice_SecondTicketShouldBeNotBeFreeForRegularVisitorsDuringWeekends()
    {
        // arrange
        const bool studentPricing = false;
        const bool premiumTickets = false;
    ...
    [Test]
    public void CalculatePrice_OrderInWeekendShouldGiveGroupDiscountIfGroupSizeIsEqualTo6People()
    {
        // arrange
        const bool studentPricing = false;
        const bool premiumTickets = false;
    ...
    // 2. The order is placed during the weekend.
    [Test]
    public void CalculatePrice_OrderInWeekendShouldGiveGroupDiscountIfGroupSizeIsMoreThan6People()
    {
        // arrange
        const bool studentPricing = false;
        const bool premiumTickets = false;
    ...
    // 2. The order is placed during the weekend.
    [Test]
    public void CalculatePrice_OrderInWeekendShouldBeFullPriceIfGroupSizeLessThan6()
    {
        // arrange
        const bool studentPricing = false;
        const bool premiumTickets = false;
    ...
    [Test]
    public void CalculatePrice_PremiumTicketShouldAdd2EuroToStudentOrderDuringTheWeekend()
    {
        // arrange
        const bool studentPricing = true;
    ...
    // 2. It should increase the price by 2 euros instead of 3 if its a ticket purchased by a student.
    [Test]
    public void CalculatePrice_PremiumTicketShouldAdd2EuroToStudentOrderDuringRegularWeekdays()
    {
        // arrange
        const bool studentPricing = true;
        const bool premiumTickets = true;
    ...
    // 2. It should increase the price by 2 euros instead of 3 if its a ticket purchased by a student.
    [Test]
    public void CalculatePrice_PremiumTicketShouldAdd3EuroToRegularOrderDuringTheWeekend()
    {
        // arrange
        const bool studentPricing = false;
        const bool premiumTickets = true;
    ...
    // 2. It should increase the price by 2 euros instead of 3 if its a ticket purchased by a student.
    [Test]
    public void CalculatePrice_PremiumTicketShouldAdd3EuroToRegularOrderDuringTheRegularWeekdays()
    {
        // arrange
        const bool studentPricing = false;
        const bool premiumTickets = true;
    ...
    [Test]
    public void CalculatePrice_PremiumTicketNoIncreasedFeesForFreeSecondTicketForStudents()
    {
        // arrange
        const bool studentPricing = true;
        const bool premiumTickets = true;
    ...
    // 2. No matter what type of role they have.
    [Test]
    public void CalculatePrice_PremiumTicketNoIncreasedFeesForFreeSecondTicketForRegular()
    {
        // arrange
        const bool studentPricing = false;
        const bool premiumTickets = true;
